...
pub mod tests {
    ...
    #[case::utf8_non_breaking_space("hello\u{00A0}world", LocaleEncoding::Utf8, counts(0, 2, 11, 12))]
    ...
    #[case::utf8_two_replacement_chars("word1\u{FFFD}word2\u{FFFD}word3", LocaleEncoding::Utf8, counts(0, 1, 17, 21))]
    ...
    #[case::c_locale_non_breaking_space_no_split("hello\u{00A0}world", LocaleEncoding::C, counts(0, 1, 12, 12))] // Non-breaking space not recognized, 1 word

    // Mixed content
    #[case::mixed_ascii_utf8("hello café 💯 world", LocaleEncoding::Utf8, counts(0, 4, 18, 22))]
    #[case::mixed_with_newlines("line1 café\nline2 💯\n", LocaleEncoding::Utf8, counts(2, 4, 19, 23))]
